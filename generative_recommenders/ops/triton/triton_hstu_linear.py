...
def _helion_ln_mul_dropout_bwd_dwdb(
    ...
    pid = tl.program_id(0)
    cols = pid * _RDIM_SIZE_1 + tl.arange(0, _RDIM_SIZE_1)
    dw = tl.zeros((BLOCK_N, _RDIM_SIZE_1), dtype=tl.float32)
    db = tl.zeros((BLOCK_N, _RDIM_SIZE_1), dtype=tl.float32)
