...
## The difference between the main branch and this one

In Line 333 of the file generative_recommenders/research/modeling/sequential/hstu.py
The parameter "dim" of the function "torch.split" is changed to -1 from 1 to expend the application. Changes on the hyperparameters of hstu may cause errors. See the Issue "on the parameter "dim" in hstu.py #461" (https://github.com/meta-recsys/generative-recommenders/issues/461).
